...
public class PathFinding : MonoBehaviour
{
    ...
    //     _tiles[startX, startY].GetComponent<Tile>().SetSumCost(0);
    //
    //     _unvisited.Clear();
    //
    //     // Populate the list.
    ...
    //     float mincost = _unvisited.Min(t => t.SumCost);
    //     _current = _unvisited.Find(t => t.SumCost == mincost);
    //
    ...
    //         
    //         t = _tiles[t.parentX, t.parentY].GetComponent<Tile>();
    //     }
    // }
    //
